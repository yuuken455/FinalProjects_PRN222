...
public partial class EVServiceManagementContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Accounts__349DA5A6593BA993");
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCC27EECEB60");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64D822AE9343");

            entity.HasIndex(e => e.AccountId, "UQ__Customer__349DA5A71E281828").IsUnique();
        ...
        {
            entity.HasKey(e => e.ManagerId).HasName("PK__Managers__3BA2AAE1D3B17DF0");

            entity.HasIndex(e => e.AccountId, "UQ__Managers__349DA5A781ADF1AA").IsUnique();
        ...
        {
            entity.HasKey(e => e.PartId).HasName("PK__Parts__7C3F0D500AA26F0D");
        ...
        {
            entity.HasKey(e => e.RequestId).HasName("PK__PartRequ__33A8517A2C08F850");
            ...
            entity.HasOne(d => d.ApprovedByNavigation).WithMany(p => p.PartRequests)
                ...
                .HasConstraintName("FK__PartReque__Appro__778AC167");

            entity.HasOne(d => d.Part).WithMany(p => p.PartRequests)
                .HasForeignKey(d => d.PartId)
                .HasConstraintName("FK__PartReque__PartI__787EE5A0");

            entity.HasOne(d => d.RequestedByNavigation).WithMany(p => p.PartRequests)
                .HasForeignKey(d => d.RequestedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PartReque__Reque__76969D2E");
        });

        modelBuilder.Entity<Payment>(entity =>
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A38105C8397");
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.Payments)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Payments__Appoin__6B24EA82");

            entity.HasOne(d => d.Customer).WithMany(p => p.Payments)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Payments__Custom__6C190EBB");
        });

        modelBuilder.Entity<PaymentDetail>(entity =>
        {
            entity.HasKey(e => e.PaymentDetailId).HasName("PK__PaymentD__7F4E340FE75FEB7E");
            ...
            entity.HasOne(d => d.Payment).WithMany(p => p.PaymentDetails)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PaymentDe__Payme__71D1E811");
        });

        modelBuilder.Entity<Service>(entity =>
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__Services__C51BB00A1909387D");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__ServiceO__D3B9D36C3DDF00A4");
        ...
        {
            entity.HasKey(e => e.ServicePartId).HasName("PK__ServiceP__F6D5C6866A5AE67D");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__ServiceR__74BC79CE688368CA");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staffs__96D4AB17DEF84BE9");

            entity.HasIndex(e => e.AccountId, "UQ__Staffs__349DA5A78838744B").IsUnique();
        ...
        {
            entity.HasKey(e => e.TechnicianId).HasName("PK__Technici__301F8121D5CB16E3");

            entity.HasIndex(e => e.AccountId, "UQ__Technici__349DA5A76049A186").IsUnique();
        ...
        {
            entity.HasKey(e => e.AssignmentId).HasName("PK__Technici__32499E77B34C572E");
        ...
        {
            entity.HasKey(e => e.VehicleId).HasName("PK__Vehicles__476B54920AD7A4E0");
